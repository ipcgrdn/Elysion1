...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
        <Dialog.Portal>
            <Dialog.Overlay
                className="bg-neutral-900/50 backdrop-blur-md fixed inset-0"
            />
            <Dialog.Content
                className="fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-lg bg-neutral-800 p-[25px] focus:outline-none"
            >
                <Dialog.Title
